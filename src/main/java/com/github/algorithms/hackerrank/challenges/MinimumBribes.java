...
public class MinimumBribes {
    ...
    public static void main(String[] args) {
        //todo move test cases to unit tests
        //testcase 0
        int[] testcase01 = {2, 1, 5, 3, 4};
        int[] testcase02 = {5, 1, 5, 4, 3};
        minimumBribesSolution1(testcase01);
        minimumBribesSolution2(testcase01);
        minimumBribesSolution1(testcase02);
        minimumBribesSolution2(testcase02);

        //testcase 1
        int[] testcase11 = {5, 1, 2, 3, 7, 8, 6, 4};
        int[] testcase12 = {1, 2, 5, 3, 7, 8, 6, 4};
        minimumBribesSolution1(testcase11);
        minimumBribesSolution2(testcase11);
        minimumBribesSolution1(testcase12);
        minimumBribesSolution2(testcase12);

        //testcase 2
        int[] testcase2 = {1, 2, 5, 3, 4, 7, 8, 6};
        minimumBribesSolution1(testcase2);
        minimumBribesSolution2(testcase2);
        ...
        minimumBribesSolution1(testcase3);
        minimumBribesSolution2(testcase3);
    }

    static void minimumBribesSolution1(int[] q) {
        int bribes = 0;

        for (int i = 0; i < q.length; i++) {
            int initialPosition = q[i] - 1;

            if (initialPosition - i > 2) {
                System.out.println("Too chaotic");
                return;
            }

            if (initialPosition > i) {
                bribes += initialPosition - i;
            } else {
                //q[i] 'bribed' by other people in the queue, but also 'bribed' person from its back
    ...
    static void minimumBribesSolution2(int[] q) {
        int bribes = 0;
